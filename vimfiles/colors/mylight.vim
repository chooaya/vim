...
" Modified {{{1
hi Normal ctermfg=black ctermbg=NONE guifg=black guibg=#e0e0e0
...
hi StatusLine   term=BOLD,reverse cterm=NONE ctermfg=Blue ctermbg=Gray guibg=grey60 guifg=Blue gui=NONE
hi StatusLineNC term=BOLD,reverse cterm=NONE ctermfg=Black ctermbg=Gray guibg=grey60 guifg=Black gui=NONE
...
hi CursorLine   guifg=NONE guibg=grey80

" Private {{{1
hi MyBrackets		guifg=DarkRed
hi SpecialKey	guifg=#b0b0b0
hi Number   term=UNDERLINE ctermfg=red gui=NONE guifg=#00a206
hi ZenkakuSpace cterm=underline ctermfg=darkgrey gui=underline guifg=grey80
